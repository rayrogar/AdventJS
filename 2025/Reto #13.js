 ...
 * 
 * Simula el recorrido de un regalo dentro de una fábrica y devuelve cómo termina. Para ello debes 
 * crear una función runFactory(factory).
...
El regalo siempre empieza en la posición (0,0) (arriba a la izquierda). En cada paso lee la celda 
actual y se mueve según la dirección. Si llega a una celda con un punto (.) significa que ha salido 
correctamente de la fábrica.
